...
:: Автоматическое обновление всех фото в папке проекта
copy /Y "C:\Users\37061\.gemini\antigravity-ide\brain\1c7d5acd-e32c-4c0f-bf32-141e6715473b\hero_chief_engineer_site_1786437032218.png" "hero_engineer.png" > nul 2>&1
